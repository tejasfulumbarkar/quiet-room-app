...
export default function RewardsPage() {
  ...
  const handleWildcardPurchase = async () => {
    console.log(" Wildcard purchase started, custom text:", customRewardText)
    ...
    try {
      ...
      console.log(" Current aura balance:", auraBalance)
      ...
      console.log(" Aura deduction result:", updateError ? "error" : "success")
      ...
      console.log(" Inventory insertion result:", inventoryError ? "error" : "success")
