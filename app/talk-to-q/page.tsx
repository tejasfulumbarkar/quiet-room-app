            ...
            <div ref={scrollRef} className="max-w-4xl mx-auto px-4 md:px-8 py-4 space-y-4">
              {isLoadingSession ? (
                ...
                <div className="text-center py-8 md:py-12">
                  ...
                  <p className="text-muted-foreground mb-8">Q is ready to help you strategize.</p>
                  ...
                  <div className="max-w-md mx-auto space-y-3">
                    ...
                    <div className="grid gap-3">
                      <Button
                        variant="outline"
                        className="h-auto p-4 text-left justify-start hover:bg-primary/5 hover:border-primary/30 transition-all"
                        onClick={() => {
                          setInput("Q, show me my stats")
                          setTimeout(() => {
                            const form = document.querySelector("form")
                            if (form) {
                              form.dispatchEvent(new Event("submit", { cancelable: true, bubbles: true }))
                      ...
                      >
                        <div className="flex items-center gap-3 w-full">
                          ...
                          <span className="text-sm">Q, show me my stats</span>
                        </div>
                      </Button>
                      ...
                      <Button
                        ...
                        className="h-auto p-4 text-left justify-start hover:bg-primary/5 hover:border-primary/30 transition-all"
                        onClick={() => {
                          setInput("What should I work on right now?")
                          setTimeout(() => {
                            const form = document.querySelector("form")
                            if (form) {
                              form.dispatchEvent(new Event("submit", { cancelable: true, bubbles: true }))
                      ...
                      >
                        <div className="flex items-center gap-3 w-full">
                          <div className="w-2 h-2 rounded-full bg-primary shrink-0" />
                          <span className="text-sm">What should I work on right now?</span>
                        </div>
                      </Button>
                    </div>
                  </div>
